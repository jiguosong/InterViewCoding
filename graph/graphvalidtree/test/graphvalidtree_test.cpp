...
TEST(graphvalidtree, normal1)
{
	graphvalidtree tc;

	vector<vector<int>> edges = {{0, 1}, {0, 2}, {0, 3}, {1, 4}};
	ASSERT_TRUE(tc.GraphValidTree(5, edges));
}

TEST(graphvalidtree, normal2)
{
	graphvalidtree tc;

	vector<vector<int>> edges = {{0, 1}, {1, 2}, {2, 3}, {1, 3}, {1, 4}};
	ASSERT_FALSE(tc.GraphValidTree(5, edges));
}
