...
#include "../src/kcomplimentarypairs.h"
...
TEST(kcomplimentarypairs, normal1)
{
    kcomplimentarypairs tc;

    vector<int> nums = {1, 8, -3, 0, 1, 3, -2, 4, 5};
    int k = 6;

    cout << tc.complimentaryPairsSumtoK(nums, k) << endl;
