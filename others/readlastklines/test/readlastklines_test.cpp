...
TEST(readlastklines, normal1)
{
	readlastklines tc;

	char *fname = "/home/songjiguo/ClionProjects/InterViewCoding/others/readlastklines/test/simpledata.txt";
	tc.ReadLastKLines(fname, 2);
