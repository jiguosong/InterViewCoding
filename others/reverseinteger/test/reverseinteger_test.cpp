...
TEST(reverseinteger, normal1)
{
	reverseinteger tc;

	cout << tc.reverseInteger(1000000009) << endl;
}

TEST(reverseinteger, normal2)
{
	reverseinteger tc;

	cout << tc.reverseInteger(-123) << endl;
}

TEST(reverseinteger, normal3)
{
	reverseinteger tc;

	cout << tc.reverseInteger(-10000) << endl;
}
