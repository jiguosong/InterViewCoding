...
#include "../../src/queuereconstructbyheight/queuereconstructbyheight.h"
...
TEST(queuereconstructbyheight, normal1)
{
    queuereconstructbyheight tc;

    vector<pair<int, int>> people{{7,0}, {4,4}, {7,1}, {5,0}, {6,1}, {5,2}};
    vector<pair<int, int>> ans = tc.reconstructQueue(people);
    for(auto p:ans) {
