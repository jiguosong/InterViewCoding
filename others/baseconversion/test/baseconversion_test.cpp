...
TEST(baseconversion, normal1)
{
    baseconversion tc;

    cout << tc.convert_10base_to_nbase(1025, 15) << endl;

    cout << tc.convert_nbase_to_10base(485, 15) << endl;

    cout << tc.convert_nbase_to_mbase(1025, 10, 10) << endl;
