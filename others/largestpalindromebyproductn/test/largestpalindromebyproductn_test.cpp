...
#include "../src/largestpalindromebyproductn.h"
...
TEST(largestpalindromebyproductn, normal1)
{
	largestpalindromebyproductn tc;

	cout << tc.LargestPalindrombyProduct(8) << endl;
