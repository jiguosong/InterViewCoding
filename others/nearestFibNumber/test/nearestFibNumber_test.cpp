...
#include "../src/nearestFibNumber.h"
...
//TEST(nearestFibNumber, normal1)
//{
//	nearestFibNumber tc;
//
//	cout << tc.FindNearestFibNumber(10) << endl;
//
//}

TEST(nearestFibNumber, normal2)
{
	nearestFibNumber tc;

	cout << tc.FindNearestFibNumber(9999999) << endl;
