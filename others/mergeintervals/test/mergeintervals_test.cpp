...
TEST(mergeintervals, normal1)
{
	mergeintervals tc;

	vector<std::pair<int, int>> intervals = {{1,3}, {2,6}, {8,10}, {15,18}};

	vector<std::pair<int, int>> ans = tc.MergeInterval(intervals);
