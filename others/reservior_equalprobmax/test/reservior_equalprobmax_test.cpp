...
#include "../src/reservior_equalprobmax.h"
...
TEST(reservior_equalprobmax, normal1)
{
	reservior_equalprobmax tc;

	vector<int> nums = {2,4,6,6,3,1,6,6};
	cout << tc.FindMaxIndex(nums) << endl;
}
