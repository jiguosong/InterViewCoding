...
#include "../src/distributemachinetoclusters.h"
...
TEST(distributemachinetoclusters, normal1)
{
	distributemachinetoclusters tc;

	vector<int> a = {200, 450};
	std::vector<std::pair<int, int>> ans = tc.DistributeBMachinetoNCluster(7,2, a);
