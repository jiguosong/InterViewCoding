...
#include "../src/longestcommonincreasingsubsequence.h"
...
TEST(longestcommonincreasingsubsequence, normal1)
{
    longestcommonincreasingsubsequence tc;

    vector<int> n1 = {3, 4, 9, 1};
    vector<int> n2 = {5, 3, 8, 9, 10, 2, 1};

    int ans = tc.LongestCommonIncreasingSubsequence(n1, n2);
    cout << ans << endl;
}
