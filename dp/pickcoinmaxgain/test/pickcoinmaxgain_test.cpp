...
TEST(pickcoinmaxgain, normal1) {
    pickcoinmaxgain tc;

    vector<int> coins = {5, 3, 7, 10};
    ASSERT_EQ(15, tc.MaxGainPickupCoin(coins));

    vector<int> coins2 = {8, 15, 3, 7};
    ASSERT_EQ(22, tc.MaxGainPickupCoin(coins2));
}
