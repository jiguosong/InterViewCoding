...
TEST(uniqestrings, normal1)
{
    uniqestrings tc;

    vector<char> chars = {'a', 'b'};
    vector<string> ans = tc.allUniqueStringfromLetters(chars, 3);
...
TEST(uniqestrings, normal2)
{
    uniqestrings tc;

    vector<char> chars = {'a', 'b', 'c', 'd'};
    vector<string> ans = tc.allUniqueStringfromLetters(chars, 1);
...
TEST(uniqestrings, normal3)
{
    uniqestrings tc;

    vector<char> chars = {'a', 'b', 'c'};
    vector<string> ans = tc.allUniqueStringfromLetters(chars, 2);
...
TEST(uniqestrings, normal4)
{
    uniqestrings tc;

    vector<char> chars = {'a', 'b', 'c'};
    vector<string> ans = tc.allUniqueStringfromLetters(chars, 4);
