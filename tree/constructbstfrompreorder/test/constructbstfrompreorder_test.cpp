...
#include "../src/constructbstfrompreorder.h"
...
TEST(constructbstfrompreorder, normal1)
{
	constructbstfrompreorder tc;

	vector<int> preorder = {20, 10, 5, 1, 7, 15, 30, 25, 35, 32, 40 };

	TreeNode *root = tc.ConstructBSTfromPreorder(preorder);
