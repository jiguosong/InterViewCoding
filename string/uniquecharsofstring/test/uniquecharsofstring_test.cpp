...
#include "../src/uniquecharsofstring.h"
...
TEST(uniquecharsofstring, normal1)
{
	uniquecharsofstring tc;

	string s = "abcdefg";
	ASSERT_TRUE(tc.AllUniqueCharsinString(s));
}

TEST(uniquecharsofstring, normal2)
{
	uniquecharsofstring tc;

	string s = "abcdefga";
	ASSERT_FALSE(tc.AllUniqueCharsinString(s));
}
