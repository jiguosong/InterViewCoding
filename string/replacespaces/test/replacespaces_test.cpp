...
TEST(replacespaces, normal1)
{
	replacespaces tc;

	string str = "abcd b sadf ak";
	tc.ReplaceSpaces(str, "%20");

	cout << str << endl;
}

TEST(replacespaces, normal2)
{
	replacespaces tc;
