...
#include "../src/removeduplicatedletters.h"
...
TEST(removeduplicatedletters, normal1)
{
    removeduplicatedletters tc;

    string s = "bcabc";
    cout << tc.RemoveDuplicatedLetters(s) << endl;
    cout << endl;

}

TEST(removeduplicatedletters, normal2)
{
    removeduplicatedletters tc;
