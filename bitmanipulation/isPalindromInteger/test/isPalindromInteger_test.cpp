...
#include "../src/isPalindromInteger.h"
...
TEST(isPalindromInteger, normal1)
{
	isPalindromInteger tc;

	ASSERT_FALSE(tc.isValidPalindromeInteger(10));

}

TEST(isPalindromInteger, normal2)
{
	isPalindromInteger tc;

	const int Max = 32;
	ASSERT_TRUE(tc.isValidPalindromeInteger((1 << (Max-1)) + (1 << 0)));
