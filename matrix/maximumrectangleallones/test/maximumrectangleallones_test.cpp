...
#include "../src/maximumrectangleallones.h"
...
TEST(maximumrectangleallones, normal1)
{
	maximumrectangleallones tc;

	Matrix<char> x(5,5);
	vector<vector<char>> matrix = x.getRandomBinaryCharMatrix();
	PrintVectorVector(matrix);

	cout << tc.maximalRectangle(matrix) << endl;
