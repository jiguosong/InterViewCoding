...
#include "../src/maximumsumofrectanglenolargerthanK.h"
...
TEST(maximumsumofrectanglenolargerthanK, normal1)
{
	maximumsumofrectanglenolargerthanK tc;

	vector<vector<int>> matrix = {{1,0,1}, {0,-2,3}};
	int k = 2;

	cout << tc.maxSumSubmatrix(matrix, k) << endl;
