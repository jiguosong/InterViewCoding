...
#include "../src/maximumrectangleinhistogram.h"
...
TEST(maximumrectangleinhistogram, normal1)
{
	maximumrectangleinhistogram tc;

	vector<int> heights = {2,1,5,6,2,3};

	cout << tc.largestRectangleArea(heights) << endl;

	cout << endl;

}

TEST(maximumrectangleinhistogram, normal2)
{
	maximumrectangleinhistogram tc;
