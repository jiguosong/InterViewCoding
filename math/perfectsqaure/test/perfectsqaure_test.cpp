...
TEST(perfectsqaure, normal1)
{
	perfectsqaure tc;

	cout << tc.perfectSqaure(100000000) << endl;
}

TEST(perfectsqaure, normal2)
{
	perfectsqaure tc;

	cout << tc.perfectSqaure(1) << endl;
}

TEST(perfectsqaure, normal3)
{
	perfectsqaure tc;

	cout << tc.perfectSqaure(0) << endl;
}


TEST(perfectsqaure, normal4)
{
	perfectsqaure tc;

	cout << tc.perfectSqaure(234876123) << endl;
}
